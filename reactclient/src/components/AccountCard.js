  ...
  return (
    ...
    >
      <div className="flex h-full flex-col justify-center leading-none">
        <div className="rounded-xl border border-valneutral-900 bg-valneutral-700 px-3 py-2 pr-[6.5rem] text-left shadow-md shadow-valneutral-900/20 ring-0 transition transition duration-200 duration-200 hover:ring-2 group-hover:!bg-valred-800 group-hover:!text-valred-100 group-hover:ring-2 group-hover:!ring-valred group-focus-visible:bg-valred-900 group-focus-visible:text-valred-100 group-focus-visible:ring-2 group-focus-visible:ring-valred-800">
          ...
          <h3 className="mt-3 max-w-[10rem] overflow-hidden text-ellipsis whitespace-nowrap font-medium uppercase text-valneutral-500 transition transition duration-200 duration-200 group-hover:!text-valred-600 group-focus-visible:text-valred-600/75">
            {alias}
          </h3>
        </div>
      </div>
